...
<div id="send_emails_loader" class="loading d-flex flex-column justify-content-center align-items-center">
    ...
    <div class="p-4 w-100" style="max-width: 500px">
        <div class="progress">
            <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="100"
                aria-valuemin="0" aria-valuemax="100" style="width:0%" id="send_emails_progress">
                <div class="text-center" id="send_emails_progress_text"> 10%</div>
            </div>
        </div>
    </div>
</div>
