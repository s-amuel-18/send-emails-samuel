...
window.addEventListener("DOMContentLoaded", (e) => {
    // const lorader_first = document.getElementById("lorader_first");
    // lorader_first.style.display = "none";
});
    ...
    jQuery(".anchor").on("click", function () {
        if ($.attr(this, "href") !== "#") {
            $("html, body").animate(
                {
                    scrollTop:
                        $($.attr(this, "href")).offset().top - topbar + 20,
                },
                800
            );
        }
...
var carousel = jQuery(".portfolio-container .owl-carousel");
